...
def build_sample(query_uid, token_ids, token_types, num_tokens, dec_in_ids, dec_out_ids, loss_mask, reference, ctx_ids):
...
class OpenQADataset(ABC, Dataset):
    ...
    def __init__(self, task_name, dataset_name, datapaths,
        ...
        for datapath in datapaths:
            self.samples.extend(self.process_samples_from_single_path(datapath, self.topk))
    ...
    @staticmethod
    def process_samples_from_single_path(filename, topk):
        ...
        with open(filename, 'r') as ifile:
            ...
            for row in reader:
                ...
                sample = {'uid': -1 * total, 'question': question, 'answers': answers, 'ctx_ids': ctx_ids}
